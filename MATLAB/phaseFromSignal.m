...
for i=1:phsPtMax
    phase(i) = sineFit(real(Eref(i:(i+phsPts-1))),t(1:(phsPts))...
        ,omega);
    for j=1:4
        bkr(j,i)= sineFit(real(E(j,i:(i+phsPts-1))),t(1:(phsPts))...
            ,omega);
    end
end
...
for i=1:phsPtMax
    phase(i) = sineFit(real(Eref2(i:(i+phsPts-1))),t2(1:(phsPts))...
        ,omega);
    bkr2(i)= sineFit(real(Ecomb(i:(i+phsPts-1))),t2(1:(phsPts))...
           ,omega);
end
